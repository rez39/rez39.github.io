...
title: About
permalink: /
subtitle: PhD Student, School of Computing, National University of Singapore
...
Before NUS, I completed a Dual Degree (B.Tech + M.S. by Research) in Electronics and Communication Engineering at IIIT Hyderabad, working on IoT-based air pollution monitoring under Prof. Sachin Chaudhari. I later worked as a Digital Design Engineer at Texas Instruments on synthesis and timing analysis for SoCs in the SITARA family, and have held research internships at Nokia Bell Labs, Cambridge (battery-free health sensing) and the Neuromuscular Control & Biomechanics Lab at the University of Alberta (wearable-based clinical activity monitoring).
